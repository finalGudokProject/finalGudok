            ...
            <div class="container box">
                ...
                <div>
                    ...
                    <br><br>
                        ...
                        <table>
                            <tr>
                                <td>상품 품질 문제</td>
                                <td id="td3">${list[0].temp2 }명</td>
                            </tr>
                            <tr>
                                <td>오배송</td>
                                <td id="td3">${list[1].temp2 }명</td>
                            </tr>
                            <tr>
                                <td>기타</td>
                                <td id="td3">${list[2].temp2 }명</td>
                            </tr>
                ...
                <br><br><br><br><br><br><br><br><br><br>
                    ...
                    <div style="float:left;">
                    	<select name="out">
                            <option value="quality">전체</option>
                            <option value="delivery">배송 대기</option>
                            <option value="service">배송중</option>
                            <option value="etc">배송 완료</option></select>
                        <select name="out">
                            <option value="quality">전체</option>
                            <option value="delivery">품질 문제</option>
                            <option value="service">오배송</option>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th style="width:130px;">신청 일자</th>
                                <th style="width:150px;">교환 사유</th>
                                <th style="width:100px;">구독 번호</th>
