      ...
      <div class="container box">
        ...
        <hr style="border-color:rgb(0, 125, 255);">
                ...
                <thead style="text-align: center;">
                  <tr>
                    <th style="width:10%; padding:20px;">이벤트</th><td style="width: 35%;">${board.bTitle }</td>
                    <th style="width: 10%;">작성일</th><td style="width: 10%;">${board.bWrite_date }</td>
                    <th style="width: 10%;">게시여부</th><td style="width: 10%;">${eventBoard.eE_status }</td>
                  </tr>
                </thead>
                <tbody>
	                  <tr>
